...
#define TAG "YcscEsp32S3Es8311DkAi"

LV_FONT_DECLARE(font_puhui_16_4);
LV_FONT_DECLARE(font_awesome_16_4);


class YcscEsp32S3Es8311DkAi : public WifiBoard {
private:
...
public:
    YcscEsp32S3Es8311DkAi() : boot_button_(BOOT_BUTTON_GPIO) {
        InitializeI2c();
        InitializeSpi();
...
DECLARE_BOARD(YcscEsp32S3Es8311DkAi);
