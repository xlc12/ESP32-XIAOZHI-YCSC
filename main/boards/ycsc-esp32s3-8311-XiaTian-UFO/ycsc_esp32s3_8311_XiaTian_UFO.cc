...
#define TAG "YcscEsp32S3Es8311XiaTianUfo"
...
class YcscEsp32S3Es8311XiaTianUfo : public WifiBoard {
private:
...
public:
    YcscEsp32S3Es8311XiaTianUfo() : boot_button_(BOOT_BUTTON_GPIO) {
        InitializeI2c();
        InitializeSpi();
...
DECLARE_BOARD(YcscEsp32S3Es8311XiaTianUfo);
